...
class ChapterStatus(models.Model):
    ...
    completedVideoLenght = models.DecimalField(max_digits=6, decimal_places=3,default=0.0)
    totalVideoLength = models.DecimalField(max_digits=6, decimal_places=3,default=0.0)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Quiz_question(models.Model):
    chapter = models.ForeignKey(Chapter, related_name='course_name', null=False, on_delete=models.CASCADE,default=1)
...
class Score(models.Model):
    ...
    chapter_score = models.ForeignKey(Chapter, related_name='chapter_score', null=False, on_delete=models.CASCADE)
